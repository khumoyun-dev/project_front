...
const UpdateUserForm = ({ user, setModalShown, setUpdateErrorShown }) => {
    ...
    return (
        <>
            ...
            <Form
                ...
                className="bg-backgroundPrimaryColor border-1 border-linesColor p-4 rounded"
            >
                <Form.Group className="mb-3 form-group" controlId="updateUserFormUsername">
                    ...
                    <Form.Control
                        ...
                        className="bg-backgroundPrimaryColor"
                    />
